...
<p>This page tests all files in production
    (<span class='ic'>.js</span>, <span class='ic'>.json</span> &amp; <span class='ic'>.php</span>)
    and helps make sure VAT rates are identical across files.
</p>
            ...
            <?php foreach ($json as $country_code => $data) : ?>
                ...
                <tr>
                    ...
                    <td class="rate rate-reduced">
                        <?php
                        if (!empty($data['rates']['reduced'])) {
                            echo join(' / ', $data['rates']['reduced']);
                        } else {
                            echo "-";
                        }
                        ?>
